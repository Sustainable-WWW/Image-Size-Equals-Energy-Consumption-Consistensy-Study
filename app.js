...
// 1000-2000 tests
app.get("/1000-2000/image-1/avif", (req, res) => res.render("1000-2000/Image-1/image-test-avif"));
app.get("/1000-2000/image-1/webp", (req, res) => res.render("1000-2000/Image-1/image-test-webp"));
app.get("/1000-2000/image-1/gif", (req, res) => res.render("1000-2000/Image-1/image-test-gif"));
app.get("/1000-2000/image-1/png", (req, res) => res.render("1000-2000/Image-1/image-test-png"));
app.get("/1000-2000/image-1/jpg", (req, res) => res.render("1000-2000/Image-1/image-test-jpg"));

app.get("/1000-2000/image-2/avif", (req, res) => res.render("1000-2000/Image-2/image-test-avif"));
app.get("/1000-2000/image-2/webp", (req, res) => res.render("1000-2000/Image-2/image-test-webp"));
app.get("/1000-2000/image-2/gif", (req, res) => res.render("1000-2000/Image-2/image-test-gif"));
app.get("/1000-2000/image-2/png", (req, res) => res.render("1000-2000/Image-2/image-test-png"));
app.get("/1000-2000/image-2/jpg", (req, res) => res.render("1000-2000/Image-2/image-test-jpg"));

app.get("/1000-2000/image-3/avif", (req, res) => res.render("1000-2000/Image-3/image-test-avif"));
app.get("/1000-2000/image-3/webp", (req, res) => res.render("1000-2000/Image-3/image-test-webp"));
app.get("/1000-2000/image-3/gif", (req, res) => res.render("1000-2000/Image-3/image-test-gif"));
app.get("/1000-2000/image-3/png", (req, res) => res.render("1000-2000/Image-3/image-test-png"));
app.get("/1000-2000/image-3/jpg", (req, res) => res.render("1000-2000/Image-3/image-test-jpg"));

app.get("/1000-2000/image-4/avif", (req, res) => res.render("1000-2000/Image-4/image-test-avif"));
app.get("/1000-2000/image-4/webp", (req, res) => res.render("1000-2000/Image-4/image-test-webp"));
app.get("/1000-2000/image-4/gif", (req, res) => res.render("1000-2000/Image-4/image-test-gif"));
app.get("/1000-2000/image-4/png", (req, res) => res.render("1000-2000/Image-4/image-test-png"));
app.get("/1000-2000/image-4/jpg", (req, res) => res.render("1000-2000/Image-4/image-test-jpg"));

app.get("/1000-2000/image-5/avif", (req, res) => res.render("1000-2000/Image-5/image-test-avif"));
app.get("/1000-2000/image-5/webp", (req, res) => res.render("1000-2000/Image-5/image-test-webp"));
app.get("/1000-2000/image-5/gif", (req, res) => res.render("1000-2000/Image-5/image-test-gif"));
app.get("/1000-2000/image-5/png", (req, res) => res.render("1000-2000/Image-5/image-test-png"));
app.get("/1000-2000/image-5/jpg", (req, res) => res.render("1000-2000/Image-5/image-test-jpg"));

app.get("/1000-2000/image-6/avif", (req, res) => res.render("1000-2000/Image-6/image-test-avif"));
app.get("/1000-2000/image-6/webp", (req, res) => res.render("1000-2000/Image-6/image-test-webp"));
app.get("/1000-2000/image-6/gif", (req, res) => res.render("1000-2000/Image-6/image-test-gif"));
app.get("/1000-2000/image-6/png", (req, res) => res.render("1000-2000/Image-6/image-test-png"));
app.get("/1000-2000/image-6/jpg", (req, res) => res.render("1000-2000/Image-6/image-test-jpg"));

app.get("/1000-2000/image-7/avif", (req, res) => res.render("1000-2000/Image-7/image-test-avif"));
app.get("/1000-2000/image-7/webp", (req, res) => res.render("1000-2000/Image-7/image-test-webp"));
app.get("/1000-2000/image-7/gif", (req, res) => res.render("1000-2000/Image-7/image-test-gif"));
app.get("/1000-2000/image-7/png", (req, res) => res.render("1000-2000/Image-7/image-test-png"));
app.get("/1000-2000/image-7/jpg", (req, res) => res.render("1000-2000/Image-7/image-test-jpg"));

app.get("/1000-2000/image-8/avif", (req, res) => res.render("1000-2000/Image-8/image-test-avif"));
app.get("/1000-2000/image-8/webp", (req, res) => res.render("1000-2000/Image-8/image-test-webp"));
app.get("/1000-2000/image-8/gif", (req, res) => res.render("1000-2000/Image-8/image-test-gif"));
app.get("/1000-2000/image-8/png", (req, res) => res.render("1000-2000/Image-8/image-test-png"));
app.get("/1000-2000/image-8/jpg", (req, res) => res.render("1000-2000/Image-8/image-test-jpg"));

app.get("/1000-2000/image-9/avif", (req, res) => res.render("1000-2000/Image-9/image-test-avif"));
app.get("/1000-2000/image-9/webp", (req, res) => res.render("1000-2000/Image-9/image-test-webp"));
app.get("/1000-2000/image-9/gif", (req, res) => res.render("1000-2000/Image-9/image-test-gif"));
app.get("/1000-2000/image-9/png", (req, res) => res.render("1000-2000/Image-9/image-test-png"));
app.get("/1000-2000/image-9/jpg", (req, res) => res.render("1000-2000/Image-9/image-test-jpg"));

// 500-1000 tests
app.get("/500-1000/image-1/avif", (req, res) => res.render("500-1000/Image-1/image-test-avif"));
app.get("/500-1000/image-1/webp", (req, res) => res.render("500-1000/Image-1/image-test-webp"));
app.get("/500-1000/image-1/gif", (req, res) => res.render("500-1000/Image-1/image-test-gif"));
app.get("/500-1000/image-1/png", (req, res) => res.render("500-1000/Image-1/image-test-png"));
app.get("/500-1000/image-1/jpg", (req, res) => res.render("500-1000/Image-1/image-test-jpg"));

app.get("/500-1000/image-2/avif", (req, res) => res.render("500-1000/Image-2/image-test-avif"));
app.get("/500-1000/image-2/webp", (req, res) => res.render("500-1000/Image-2/image-test-webp"));
app.get("/500-1000/image-2/gif", (req, res) => res.render("500-1000/Image-2/image-test-gif"));
app.get("/500-1000/image-2/png", (req, res) => res.render("500-1000/Image-2/image-test-png"));
app.get("/500-1000/image-2/jpg", (req, res) => res.render("500-1000/Image-2/image-test-jpg"));

app.get("/500-1000/image-3/avif", (req, res) => res.render("500-1000/Image-3/image-test-avif"));
app.get("/500-1000/image-3/webp", (req, res) => res.render("500-1000/Image-3/image-test-webp"));
app.get("/500-1000/image-3/gif", (req, res) => res.render("500-1000/Image-3/image-test-gif"));
app.get("/500-1000/image-3/png", (req, res) => res.render("500-1000/Image-3/image-test-png"));
app.get("/500-1000/image-3/jpg", (req, res) => res.render("500-1000/Image-3/image-test-jpg"));

app.get("/500-1000/image-4/avif", (req, res) => res.render("500-1000/Image-4/image-test-avif"));
app.get("/500-1000/image-4/webp", (req, res) => res.render("500-1000/Image-4/image-test-webp"));
app.get("/500-1000/image-4/gif", (req, res) => res.render("500-1000/Image-4/image-test-gif"));
app.get("/500-1000/image-4/png", (req, res) => res.render("500-1000/Image-4/image-test-png"));
app.get("/500-1000/image-4/jpg", (req, res) => res.render("500-1000/Image-4/image-test-jpg"));

app.get("/500-1000/image-5/avif", (req, res) => res.render("500-1000/Image-5/image-test-avif"));
app.get("/500-1000/image-5/webp", (req, res) => res.render("500-1000/Image-5/image-test-webp"));
app.get("/500-1000/image-5/gif", (req, res) => res.render("500-1000/Image-5/image-test-gif"));
app.get("/500-1000/image-5/png", (req, res) => res.render("500-1000/Image-5/image-test-png"));
app.get("/500-1000/image-5/jpg", (req, res) => res.render("500-1000/Image-5/image-test-jpg"));

app.get("/500-1000/image-6/avif", (req, res) => res.render("500-1000/Image-6/image-test-avif"));
app.get("/500-1000/image-6/webp", (req, res) => res.render("500-1000/Image-6/image-test-webp"));
app.get("/500-1000/image-6/gif", (req, res) => res.render("500-1000/Image-6/image-test-gif"));
app.get("/500-1000/image-6/png", (req, res) => res.render("500-1000/Image-6/image-test-png"));
app.get("/500-1000/image-6/jpg", (req, res) => res.render("500-1000/Image-6/image-test-jpg"));

app.get("/500-1000/image-7/avif", (req, res) => res.render("500-1000/Image-7/image-test-avif"));
app.get("/500-1000/image-7/webp", (req, res) => res.render("500-1000/Image-7/image-test-webp"));
app.get("/500-1000/image-7/gif", (req, res) => res.render("500-1000/Image-7/image-test-gif"));
app.get("/500-1000/image-7/png", (req, res) => res.render("500-1000/Image-7/image-test-png"));
app.get("/500-1000/image-7/jpg", (req, res) => res.render("500-1000/Image-7/image-test-jpg"));

app.get("/500-1000/image-8/avif", (req, res) => res.render("500-1000/Image-8/image-test-avif"));
app.get("/500-1000/image-8/webp", (req, res) => res.render("500-1000/Image-8/image-test-webp"));
app.get("/500-1000/image-8/gif", (req, res) => res.render("500-1000/Image-8/image-test-gif"));
app.get("/500-1000/image-8/png", (req, res) => res.render("500-1000/Image-8/image-test-png"));
app.get("/500-1000/image-8/jpg", (req, res) => res.render("500-1000/Image-8/image-test-jpg"));

app.get("/500-1000/image-9/avif", (req, res) => res.render("500-1000/Image-9/image-test-avif"));
app.get("/500-1000/image-9/webp", (req, res) => res.render("500-1000/Image-9/image-test-webp"));
app.get("/500-1000/image-9/gif", (req, res) => res.render("500-1000/Image-9/image-test-gif"));
